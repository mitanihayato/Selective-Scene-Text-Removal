...
def pair(dir_input):
    '''
        ...
        output: [[background0.png, scene0.png, text0.png], 
                       [background3.png, scene3.png, text3.png], 
                       [background10.png, scene10.png, text10.png], ...]
    '''
    ...
    for i in range(len(files)):
        ...
        input2_img_name = 'scene' + img_num + '.png'
        label_img_name = 'text' + img_num + '.png'
