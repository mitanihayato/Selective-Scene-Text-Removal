...
def pair(dir_label, file):
    ...
    with open(file) as f:
        ...
        for i in range(len(files)):
            ...
            label1_img_name = 'background' + img_num + '.png'
            pair = [input_img_name, label1_img_name, label_img_name, condition_num]
...
class SynthTextDataset(Dataset):
    ...
    def __init__(self, im_list, input_root_dir, label_root_dir, label2_root_dir, target_size, data_name, transform=None):
    ...
    def __getitem__(self, idx):
        ...
        label_img_name2 = os.path.join(self.label2_root_dir,
        ...
        label_image2 = torch.from_numpy(io.imread(label_img_name2).transpose(2,0,1))

        target_offset = self.data_name_list[idx][3]
        ...
        if self.transform:
             ...
             label_image2 = resize_w_pad(label_image2, self.target_size, self.target_size) / 255.
             
        return input_image, label_image, label_image2, input_condition