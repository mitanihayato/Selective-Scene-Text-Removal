...
def pair(dir_input):
    '''
        ...
        output: [[scene0.png, background0.png], 
                       [secen3.png, background3.png], 
                       [secen10.png, background10.png],]
    '''
    ...
    for i in range(len(files)):
        ...
        label_img_name = 'background' + img_num + '.png'
        pair = [input_img_name, label_img_name]
...
class SynthTextDataset(Dataset):
    ...
    def __init__(self, im_list, input_root_dir, label_root_dir, target_size, transform=None):
